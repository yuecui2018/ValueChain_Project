...
import os
import sys
sys.path.insert(0, os.path.abspath('../models/')) ###change the directory
sys.path.insert(0, os.path.abspath('../src/models/')) ###change the directory
...
project = 'soccer_event'
copyright = '2018, Grace Cui'
author = 'Grace Cui'
